...
const inputClass =
  "rounded-xl border border-pink-100 bg-white px-3 py-2 text-black outline-none transition focus:border-pink-300 focus:ring-2 focus:ring-pink-50";
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-sm flex-col justify-center px-4">
      <div className="mb-6 text-center">
        ...
        <p className="text-sm text-black/50">Inicia sesión en Libros</p>
      </div>
      <form
        action={formAction}
